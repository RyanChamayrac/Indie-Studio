...
IF (NOT Irrlicht_INCLUDE_DIRS OR NOT Irrlicht_LIBRARIES)
  FIND_PATH(Irrlicht_INCLUDE_DIRS
    ...
    PATHS
      ...
      ${PATH_MODULE_Irrlicht}/include/ # Expected to contain the path to this file for Windows10
  ...
  FIND_LIBRARY(Irrlicht_LIBRARIES
    ...
    PATHS
      ...
      ${PATH_MODULE_Irrlicht}/         # Expected to contain the path to this file for Windows10
